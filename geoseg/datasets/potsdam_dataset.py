...
def val_aug(img, mask):
    crop_aug = Compose([SmartCropV1(crop_size=768, max_ratio=0.75, ignore_index=len(CLASSES), nopad=False)])
    img, mask = crop_aug(img, mask)
    img, mask = np.array(img), np.array(mask)
...
class PotsdamDataset(Dataset):
    def __init__(self, data_root='/home/lyu/datasets/Potsdam/test', mode='val', img_dir='images_1024', mask_dir='masks_1024',
