...
from geoseg.models.MobileOne import mobileone
...
class MobileOneFormer(nn.Module):
    def __init__(self,
                 decode_channels=64,
                 dropout=0.1,
        ...
        super().__init__()
        self.backbone = mobileone(variant='s3')

        encoder_channels = (128, 320, 768, 2048)
