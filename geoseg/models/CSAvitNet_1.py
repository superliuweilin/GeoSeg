...
from geoseg.models.MobilevitV2_1 import mobilevit_s
...
class CSAvitNet(nn.Module):
    def __init__(self,
        ...
        self.decoder = Decoder(encoder_channels, decode_channels, dropout, window_size, num_classes,resolutions=resolutions)
...
if __name__ == '__main__':
    ...
    # # # print(model)
    inputs = torch.FloatTensor(np.random.rand(2, 3, 768, 768))
    out = model(inputs)
    print(out[0].shape)