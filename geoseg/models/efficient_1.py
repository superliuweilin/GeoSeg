...
class CascadedGroupAttention(torch.nn.Module):
    ...
    def forward(self, x):  # x (B,C,H,W)
        ...
        feat = feats_in[0]
        # [50, 32, 7, 7]
        # print('feats_in[0]', feats_in[0].shape)
        # print('feats_in[1]', feats_in[1].shape)
        # print('feats_in[2]', feats_in[2].shape)
...
class EfficientViTBlock(torch.nn.Module):    
    ...
    def forward(self, x):
        ...
        # print('x', x.shape)
        # print('after block', (self.ffn1(self.dw1(self.mixer(self.ffn0(self.dw0(x)))))).shape)
