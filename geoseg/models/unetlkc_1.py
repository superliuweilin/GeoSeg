...
class GlobalLocalAttention(nn.Module):
    def __init__(self,
        ...
        super().__init__()
        self.GL = RepLKNetBlock(channels=channels, num_blocks=num_blocks, stage_lk_size=stage_lk_size,
                                drop_path=drop_path,
...
class Block(nn.Module):
    def __init__(self, dim=256, num_heads=16, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.attn = GlobalLocalAttention(dim, window_size=window_size)
