...
from geoseg.models.ResNeSt.splat import SplAtConv2d, DropBlock2D
from geoseg.models.ResNeSt.build import RESNEST_MODELS_REGISTRY
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
                 num_classes=6, dilated=False, dilation=1,
