...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.b4 = Block(dim=decode_channels, num_heads=8, window_size=window_size, depth=depths[0])

        self.b3 = Block(dim=decode_channels, num_heads=8, window_size=window_size, depth=depths[1])
        self.p3 = WF(encoder_channels[-2], decode_channels)

        self.b2 = Block(dim=decode_channels, num_heads=8, window_size=window_size, depth=depths[2])
...
class UNetMobilevitV2(nn.Module):
    def __init__(self,
                 decode_channels=64,
                 dropout=0.1,
...
if __name__ == '__main__':
    model = UNetMobilevitV2()
    # print(model)

    inputs = torch.FloatTensor(np.random.rand(1, 3, 64, 64))
    out = model(inputs)
    print(out[0].shape)