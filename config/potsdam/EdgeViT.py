...
from geoseg.models.EdgeViTSeg import EdgeViTSeg
...
weights_name = "EdgeViTSeg_512_300epoch"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "EdgeViTSeg_512_300epoch"
...
#  define the network
net = EdgeViTSeg(num_classes=num_classes)
