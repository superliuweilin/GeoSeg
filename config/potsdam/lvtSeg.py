...
from geoseg.models.lvtSeg import lvtSeg
...
weights_name = "lvtSeg_512_300epoch_2"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "lvtSeg_512_300epoch_2"
...
resume_ckpt_path = 'model_weights/potsdam/LVTCSAvit/last.ckpt'
#  define the network
net = lvtSeg(num_classes=num_classes)
