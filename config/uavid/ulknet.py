...
from geoseg.models.unetlkc import ULKNet
...
weights_name = "ulknet_lkblock-8_lksize-27"
...
train_dataset = UAVIDDataset(data_root='/home/lyu3/datasets/uavid/train_val', img_dir='images', mask_dir='masks',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root='/home/lyu3/datasets/uavid/val', img_dir='images', mask_dir='masks', mode='val',
