...
weights_name = "ulknet-epoch100"
weights_path = "model_weights/loveda/{}".format(weights_name)
test_weights_name = "ulknet-epoch100"
...
train_dataset = LoveDATrainDataset(transform=train_aug, data_root='/home/lyu3/datasets/loveda/Train')
