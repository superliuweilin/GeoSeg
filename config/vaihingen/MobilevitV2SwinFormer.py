...
from geoseg.models.MobilevitV2SwinFormer import MobilevitV2SwinFormer
...
weights_name = "MobilevitV2SwinFormer_512_300epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MobilevitV2SwinFormer_512_300epoch"
...
#  define the network
net = MobilevitV2SwinFormer(num_classes=num_classes)
