...
weights_name = "MobilevitV2Former_512_no_fusion300epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MobilevitV2Former_512_no_fusion300epoch"
...
#  define the network
net = MobilevitV2Former(num_classes=num_classes)
