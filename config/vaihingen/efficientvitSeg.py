...
from geoseg.models.efficientvitSeg import EfficientViTSeg
...
weights_name = "EfficientViTSeg_512_300epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "EfficientViTSeg_512_300epoch"
...
#  define the network
net = EfficientViTSeg(num_classes=num_classes)
