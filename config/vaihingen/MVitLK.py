...
from geoseg.models.unetlkc import MVitLK
...
weights_name = "ulknet_LKblock_2_LKsize_27_150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "ulknet_LKblock_2_LKsize_27_150"
...
#  define the network
net = MVitLK(num_classes=num_classes)
