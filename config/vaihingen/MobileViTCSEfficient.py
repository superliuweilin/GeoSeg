...
weights_name = "MobilevitV2CSEfficient_512_without_cascaded_300epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MobilevitV2CSEfficient_512_without_cascaded_300epoch"
...
lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=500, T_mult=1)
