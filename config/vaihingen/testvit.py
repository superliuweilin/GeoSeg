...
from geoseg.models.testvit_local import UNetMobilevitV2
...
weights_name = "UNetMobilevitV2_512_150_local_path"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "UNetMobilevitV2_512_150_local_path"
