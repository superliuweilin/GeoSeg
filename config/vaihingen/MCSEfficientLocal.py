...
from geoseg.models.MobilevitV2FormerLocal_without_aux import MobilevitV2Efficient
...
weights_name = "MobileViTCSEfficientLocal_without_aux_512_300epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MobileViTCSEfficientLocal_without_aux_512_300epoch"
