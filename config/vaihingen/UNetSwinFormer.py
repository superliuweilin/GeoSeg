...
from geoseg.models.UNetSwinFormer import UNetSwinFormer
...
weights_name = "UNetSwinFormer_512_105epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "UNetSwinFormer_512_105epoch"
...
#  define the network
net = UNetSwinFormer(num_classes=num_classes)
