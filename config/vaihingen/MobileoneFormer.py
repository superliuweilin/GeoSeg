...
from geoseg.models.MobileOneFormer import MobileOneFormer
...
weights_name = "MobileOneFormer_s3_512_200epoch"
weights_path = "./out/model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MobileOneFormer_s3_512_200epoch"
...
#  define the network
net = MobileOneFormer(num_classes=num_classes)
