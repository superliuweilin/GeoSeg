...
from geoseg.models.ResNet18Seg import ResNet18Seg
...
weights_name = "Res18Seg_512_200"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "Res18Seg_512_200"
...
#  define the network
net = ResNet18Seg(num_classes=num_classes)
