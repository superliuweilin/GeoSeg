...
from geoseg.models.MobileViTV2Seg import MobilevitV2Seg
...
weights_name = "MobilevitV2Seg_512_300epoch"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MobilevitV2Seg_512_300epoch"
...
#  define the network
net = MobilevitV2Seg(num_classes=num_classes)
